(function (global, factory) {
	...
	(factory((global.subunit = global.subunit || {}),global.THREE));
...
function selectionCreator(name) {
  ...
  if (typeof name === 'function') {
    ...
    Func = THREE__default.Mesh;
  } else if (name === 'line') {
    Func = THREE__default.Line;
  } else if (name === 'object' || name === 'g') {
    Func = THREE__default.Object3D;
  } else {
...
var attr$1 = function(name, value) {
...
var attrTween$1 = function(name, value) {
...
var on$1 = function(name, listener) {
  var id = this._id;
...
Selection.prototype.select = select$1;
...
function select(item) {
  ...
  const root = new Selection([[new THREE.Object3D()]], [node]);
